...
export function Navbar({
  ...
  return (
    <header className="sticky top-0 z-30 bg-[#0B0B0C]/95 backdrop-blur-md border-b border-[#242428] px-3 lg:px-8 py-1.5">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        ...
        <div className="flex items-center">
          ...
          >
            ...
            <span className="text-[14px] font-semibold tracking-tight text-[#F5F5F5]">
              BisnisKu
            </span>
          </button>
        </div>
            ...
            <>
              ...
              {onOpenQuickTxModal && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 text-[10px] font-semibold text-[#0B0B0C] bg-[#22C55E] hover:bg-[#16A34A] rounded-lg transition-colors active:scale-[0.98] select-none"
